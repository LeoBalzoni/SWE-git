 ...
 * 
 */
@WebServiceClient(name = "ServerImplService", targetNamespace = "http://aaaws.mycompany.com/", wsdlLocation = "http://localhost:8080/BankServer?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVERIMPLSERVICE_QNAME = new QName("http://aaaws.mycompany.com/", "ServerImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/BankServer?wsdl");
    ...
    public ServerInterface getServerImplPort() {
        return super.getPort(new QName("http://aaaws.mycompany.com/", "ServerImplPort"), ServerInterface.class);
    }
     ...
     */
    @WebEndpoint(name = "ServerImplPort")
    public ServerInterface getServerImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://aaaws.mycompany.com/", "ServerImplPort"), ServerInterface.class, features);
    }
