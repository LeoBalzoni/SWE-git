 ...
 * 
 */
@WebServiceClient(name = "BankImplService", targetNamespace = "http://bankws.softeng.sapienza.it/", wsdlLocation = "http://192.168.49.81:8080/BankInterface?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://192.168.49.81:8080/BankInterface?wsdl");
